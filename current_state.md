...
- Prochaine étape : reste de la Phase 2 (`gestion-ecole`, `gestion-auberge`, `gestion-comptable`, `gestion-restaurant`, `agence-livraison`), au fil des sessions, sans rythme fixe.
